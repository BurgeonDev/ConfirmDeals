                        ...
                        <div id="tns1-mw" class="tns-ovh">
                            <div class="tns-inner" id="tns1-iw">
                                {{-- <div class="category-slider tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                    id="tns1"
                                    style="transition-duration: 0s; transform: translate3d(-29.0323%, 0px, 0px);"><a
                                    ...
                                    <!-- End Single Category -->
                                    <!-- Start Single Category -->
                                    <a href="category.html" class="single-cat tns-item" id="tns1-item6"
                                        aria-hidden="true" tabindex="-1">
                                        <div class="icon">
                                ...
                                <div class="category-slider tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                    ...
                                    @foreach ($categories as $category)
                                        <a href="{{ route('categories.cat') }}" class="single-cat tns-item">
                                            <div class="icon">
                                                <!-- You can add category icon here if available -->
                                            </div>
                                            <h3>{{ $category->name }}</h3>
